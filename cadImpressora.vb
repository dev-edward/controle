...
Public Class cadImpressora
    ...
    Private Sub cadImpressora_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lbl_ip.Font = fonte
        txt_ip.Font = fonte
        lbl_tipotoner.Font = fonte
        cbx_tipotoner.Font = fonte
        ...
        lbl_ip.Text = "IP"
        lbl_tipotoner.Text = "Tipo de toner"
        ...
        lbl_tipotoner.Size = New Size(Wpadrao, 20)
        cbx_tipotoner.Size = New Size(Wpadrao, 20)
        rdb_corpb.Size = New Size(Wpadrao, 20)
        rdb_corcl.Size = New Size(Wpadrao, 20)
        ...
        lbl_tipotoner.Location = New Point(10, y * 7)
        cbx_tipotoner.Location = New Point(10, y * 8)
        rdb_corpb.Location = New Point(10, y * 9)
        rdb_corcl.Location = New Point(110, y * 9)
    ...
    Private Sub btn_cadastrar_Click()
        ...
        consulta.CommandText = "insert into tb_item(item_tipo) values(2)
